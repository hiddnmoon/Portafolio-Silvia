      ...
      >
        ...
        >
          <div className="max-w-4xl px-6 py-12 mt-14">
            ...
            Introducción del Proyecto El cortometraje presentado para el certamen de cortometrajes de Castilblanco de los Arroyos, 
            ...
            <p className="text-lg text-gray-200">
            Equipo de Producción: El equipo estuvo compuesto por 10 personas, permitiendo una distribución de roles más específica y colaborativa. 
            ...
            <ul className="list-disc list-inside text-gray-200">
              <li className='text-lg'>Maquillaje y Vestuario: Diseñé y supervisé el maquillaje y vestuario de los personajes, asegurando que cada 
                detalle contribuyera a la construcción de sus personalidades y a la atmósfera del cortometraje.
              </li>
              <li className='text-lg'>Script: Me encargué de la continuidad y de asegurar que todos los elementos visuales y narrativos se 
            ...
            <ul className="list-disc list-inside text-gray-200">
              <li className='text-lg'>Narrativa: La historia resuena con cualquier audiencia que haya experimentado conflictos 
                familiares y la lucha por la independencia personal.
              </li>
              <li className='text-lg'>Dirección de Fotografía: Los planos nocturnos fueron diseñados para ser particularmente llamativos, 
                utilizando técnicas de iluminación y encuadre que destacan la tensión y la emoción del protagonista.
              </li>
              <li className='text-lg'>Producción Local: La elección de grabar en una casa local no solo aporta autenticidad al cortometraje,
