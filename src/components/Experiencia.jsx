    ...
    <>
      ...
      >
        ...
        >
              ...
              <div className="grid grid-cols-3 gap-8 max-w-5xl w-full px-8">
              ...
              <div className="flex flex-col items-center col-span-3">
                ...
                <div className="col-span-1" />
                  ...
                  <div className="border-2   border-white bg-opacity-10 rounded-lg p-4 text-center">
                    ...
                    <p className="mt-2 text-sm">Creación de páginas web en WordPress, optimizando diseño responsive.
                      Realicé consultas SQL en un entorno de bases de datos para mejorar la eficiencia del sistema.</p>
                  </div>
