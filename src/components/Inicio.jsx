  ...
  return (
    <>
      ...
      >
        ...
        >
          <div className={`flex ${isMobile ? 'flex-col-reverse' : 'flex-row'} items-center md:flex-row`}>
            <div className={`flex-grow ${isMobile ? 'w-full' : 'md:w-3/4'} flex flex-col justify-center p-4 ${isMobile ? 'mt-4' : 'md:mt-0'}`}>
              ...
              <p className="text-white mt-3 text-justify max-w-md">
              ...
              <div className="flex justify-center md:justify-start mt-4">
                <a href="https://github.com/crodros2601" target="_blank" rel="noopener noreferrer">
                  <img src={gitHub} className="w-12" alt="Icono de GitHub" />
                </a>
                <div>
                  <a href="https://www.linkedin.com/in/carmelorodriguezrosalina/" target="_blank" rel="noopener noreferrer">
                    <img src={linkedin} className="w-10 ml-4" alt="Icono de Linkedin" />
                  </a>
                </div>
                <div>
                  <a href="https://www.instagram.com/karmelartem" target="_blank" rel="noopener noreferrer">
                    <img src={instagram} className="w-8 ml-4" alt="Icono de Instagram" />
                  </a>
                </div>
                <div>
                  <button className="w-20 p-1 mt-4 bg-white rounded-full font-extrabold" onClick={descargarCV}>
                    CV
                  </button>
                </div>
                <div>
                  <button className="w-28 font-extrabold p-1 mt-4 ml-4 bg-white rounded-full" onClick={() => navegacion("Contacto")}>
                    CONTACTO
                  </button>
                </div>
              </div>
            </div>
            <div className={`flex-none ${isMobile ? 'w-full mt-4' : 'md:w-1/4'} flex items-center justify-center p-4`}>
              <img src={yo} className="rounded-full w-48 h-48 object-cover hover:scale-110" alt="Imagen de Carmelo Rodríguez" />
            </div>
          </div>
        </div>
      </Transition>
